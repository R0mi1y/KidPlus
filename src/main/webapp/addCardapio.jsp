...
<title>Adicionar Cardapio</title>
</head>
<body>
	<div id="sidebar" class="hidden">
		...
		<div class="btn-menu">
			...
			<ol>
				<li><a href="sair" class="ensino">Sair</a></li>
				<br>
	...
	<div class="container">
		<form action="addCardapio" style="max-width: 565px;">
			<h1 class="login" style="margin-bottom: 50px; letter-spacing: 6px;">
				CARDAPIO<br>DO DIA <%= request.getAttribute("dia") %>
			</h1>
			<div class="input-single">
				<textarea style="width: 505px; max-width: 505px; min-width: 250px;" name="cardapio" id="userName" class="input" type="text" value="<%= new DAO().getCardapio(Integer.parseInt(request.getAttribute("dia").toString())) %>"
					required></textarea> <label for="userName">Cardapio</label>
			</div>
			<br>
			<button type="submit"
