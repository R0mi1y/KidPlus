...
<head id="body">
    ...
    <title>Dia <%= request.getAttribute("diaC").toString() %></title>
</head>
            ...
            <!-- <div style="float: left;"> -->
                <div id="tabelaAlunos" style="width: 685px; padding-top: 0px;">
                    ...
                    <table align="center" cellspacing="21" cellpadding="21" id="calendario" style="	border-radius: 10px;">
                        ...
                        <caption align="top" id="topoCalendario" style="margin-top: 0px;	border-radius: 10px;">
                            <p style="font-size: 20px; letter-spacing: 3px;">Calendario de Eventos</h1>
                            <p style="backdrop-filter: brightness(70%);	border-radius: 10px;font-size: 15px; letter-spacing: 3px;">Fevereiro</h3>
                        </caption>
                            <tr >
                                <th>Dom</th>
                                <th>Seg</th>
