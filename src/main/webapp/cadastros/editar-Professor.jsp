...
<body>
    ...
    <div class="container hidden" style="max-width: none;">
        ...
        <form action="editarProfessor">
            <h1 class="titulo">
                EDITAR<br>PROFESSOR
            </h1>
            <div class="cad-input-single">
                <input name="nome" value="<%= pro.getNome()%>" type="text" id="cad-nome" class="cad-input" style="width: 200px;" required>
                <label for="cad-nome" >Nome</label>
            </div>
            <div class="cad-input-single">
                <input name="telefone" type="text" id="cad-telefone" value="<%= pro.getTelefone() %>" class="cad-input" required style="width: 200px; left: 35px;">
                <label for="cad-telefone" >Telefone</label>
            </div>
            <div class="cad-input-single">
                <input name="email" type="text" id="cad-telefone" value="<%= pro.getEmail() %>" class="cad-input" required style="width: 200px; left: 35px;">
                <label for="cad-telefone" >E-mail</label>
            </div>
